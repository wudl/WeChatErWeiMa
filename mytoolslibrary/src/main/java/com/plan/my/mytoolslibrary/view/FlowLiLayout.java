 ...
 * 动态加载
 * @author wudl
 * Created by wudl on 2016/10/8 17:15
 * <p/>
 * 邮箱 770616344@qq.com
 */
...
public class FlowLiLayout  extends ViewGroup {


    public FlowLiLayout(Context context, AttributeSet attrs, int defStyle) {
        super(context, attrs, defStyle);
        // TODO Auto-generated constructor stub
//        DEFAULT_SPACING = Dp2PxUtils.dip2px(context,6);
//        mHorizontalSpacing = DEFAULT_SPACING;
    }

    public FlowLiLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        // TODO Auto-generated constructor stub
//        DEFAULT_SPACING = Dp2PxUtils.dip2px(context,6);
//        mHorizontalSpacing = DEFAULT_SPACING;
    ...
    /**
     * true://把剩余空间平均到每个View(铺满整行)
     * false:按照自己宽度来适应，不再二次调宽度
     * **/
    private boolean isAllWidth = false;
    public FlowLiLayout(Context context) {
        super(context);
    }
     ...
     * @param isAllWidth
     */
    public void isSetAllWidth(boolean isAllWidth) {
